...
export function MapaSupermercadosScreen() {
  ...
  const [seleccionado, setSeleccionado] = React.useState<Seleccionado | null>(null);

  const {
    ubicacion, cargandoUbicacion, supermercados, solicitarUbicacion,
  ...
  return (
    <View style={s.contenedor}>
      ...
      <View style={s.panel}>
        ...
        <TouchableOpacity style={s.btnUbicacion} onPress={actualizar}>
